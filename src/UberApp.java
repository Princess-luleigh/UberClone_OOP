import java.util.*;
	...
	public class UberApp {
	    ...
	    public static void main(String[] args) {
	        ...
	        Passenger lulamani = new Passenger("Lulamani.baloyi@gmail.com", "Lulamani", "Baloyi","0818940245", 12000);        
	        ...
	        UberRide uberRide = new UberRide(startPoint, endPoint, lulamani);
